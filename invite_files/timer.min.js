(function () {
  var n = function (t, e) {
    ...
    o = {}.hasOwnProperty;
  ((this.flipchartCss =
    '<link href="https://megatimer.ru/timer/timer.min.css?v=3" rel="stylesheet" type="text/css">'),
    (this.MegaTimer = (function () {
      ...
      return (
        ...
        (t.prototype.run = function () {
          ...
          if (
            null != this.id &&
            ((d = this.id), u.call(h, d) < 0) &&
            (h.push(this.id), this.initView(), this.initType(), null != this.id)
          ) {
            for (i in ((this.container = document.getElementById(
              "timer" + this.id,
            )),
              ...
              ((l = a[p]),
                ...
                e
                  ...
                  : (((n = document.createElement("span")).className =
                      "timer-separator"),
                    (n.id = "timer-separator-" + this.id + "-" + l),
        ...
        (t.prototype.initDesign = function () {
          if (null != this.params.design) {
            ...
            ((null == t || ("text" !== t && "plate" !== t && "circle" !== t)) &&
              (t = "text"),
        ...
        (t.prototype.initCommonDesign = function () {
          var t, e, i, a, r, s;
          for (r in ((this.container.style.textAlign = "center"),
          (this.container.style.webkitTransform = "translate3d(0,0,0)"),
          (s = []),
          this.timerElements))
            ((t = document.getElementById(
              "timer-element-" + this.id + "-" + r,
            )),
              (e = document.getElementById(
                "timer-number-" + this.id + "-" + r,
              )),
              (a = document.getElementById("timer-text-" + this.id + "-" + r)),
              ...
              this.timerElements[r].view
                ...
                : ((t.style.display = "none"),
                  ...
                  null != i
                    ? s.push((i.style.display = "none"))
                    : s.push(void 0)));
          return s;
        }),
        (t.prototype.initTextDesign = function () {
          var t, e, i, a, r;
          for (r in ((e = []), (a = []), this.timerElements))
            (e.push(
              document.getElementById("timer-number-" + this.id + "-" + r),
            ),
              null !=
                (i = document.getElementById(
                  "timer-text-" + this.id + "-" + r,
                )) &&
                (a.push(i),
          ...
          return (
            ...
            this.setFonts(a, "text"),
            this.setSeparators()
          );
        }),
        (t.prototype.initCircleDesign = function () {
          var t, e, i, a, r, s, n, o, l, p;
          for (l in ((r = []), (o = []), this.timerElements))
            (r.push(
              document.getElementById("timer-number-" + this.id + "-" + l),
            ),
              null !=
                ...
                (o.push(n),
                null != this.params.design.params["text-margin"] &&
                  ("auto" !== (a = this.params.design.params["text-margin"]) &&
                    (a = parseInt(a) + "px"),
                  (n.style.marginTop = a))));
          for (l in (this.setFonts(r, "number"),
          ...
          this.timerElements))
            this.timerElements[l].view &&
              ...
              null !=
                ...
                "none" !== s.style.display.toLowerCase() &&
        ...
        (t.prototype.initPlateDesign = function () {
          ...
          switch (
            ((t = function (t, e, i) {
              ...
              switch (
                (null == i && (i = !1),
                (n = f.params.design.params.effect),
                ((r = document.createElement("span")).id =
                  "timer-number-" + n + e + "-" + f.id + "-" + t),
                (r.className = "timer-" + n + "-inner"),
                i &&
                  null != f.params.design.params.space &&
                  ((s = parseInt(f.params.design.params.space)) <= 0 && (s = 1),
                  (r.style.marginRight = s + "px")),
                (a = 8),
            ...
            (e = function (t, e, i, a) {
              return (
                null == i && (i = ""),
                null == a && (a = null),
                null != y.params.design.params[e] || null != a
                  ? (null == a && (a = y.params.design.params[e]),
                    t + ":" + a + i + ";")
                  : ""
              );
            }),
            ...
            (d = []),
            (c = []),
            (null == (n = (b = y = f = this).params.design.params.effect) ||
              ("none" !== n &&
                "flipchart" !== n &&
                "slide" !== n &&
                "no-slide" !== n) ||
            ...
            case "flipchart":
              switch (((l = s = ""), i)) {
                ...
                case "solid":
                  ...
                  break;
                case "gradient":
                  null != (a = this.params.design.params["background-color"]) &&
                    "object" == typeof a &&
                    1 < a.length &&
                    (this.params.design.params.animation && (a[0] = h(a[0])),
                    this.params.design.params.animation && (a[1] = h(a[1])),
                    (l =
                      "#timer" +
                      this.id +
          ...
          for (g in (this.addCssLink(flipchartCss),
          this.addCustomCss(s),
          this.timerElements))
            (null !=
        ...
        (t.prototype.setSeparators = function () {
          ...
          for (o in ((t = "inline-block"),
          (i = 0),
          (n = ""),
          (i = this.params.design.params["separator-margin"]) <= 0 && (i = 1),
          (n =
          ...
          (l = []),
          this.timerElements))
            l.push(this.timerElements[o].view);
          for (
            e = p = h = l.length - 1;
            h <= 0 ? p <= 0 : 0 <= p;
            e = h <= 0 ? ++p : --p
          ...
          for (o in ((e = 0), this.timerElements))
            (null !=
              (a = document.getElementById(
                "timer-separator-" + this.id + "-" + o,
              )) && r.push(a),
              s.push(l[e] ? t : "none"),
              e++);
          for (m = e = 0, d = r.length; m < d; m++)
            (((a = r[m]).style.display = s[e]),
              (a.innerHTML = n),
              (a.style.paddingTop = 0),
              (a.style.paddingRight = i + "px"),
              (a.style.paddingBottom = 0),
              (a.style.paddingLeft = i + "px"),
              e++);
        ...
        (t.prototype.getCssFonts = function (t) {
          ...
          if (
            ...
            null != this.params.design &&
              ...
              ((a = this.params.design.params[t + "-font-family"]),
              (r = this.params.design.params[t + "-font-size"]),
              (i = this.params.design.params[t + "-font-color"]),
              null != r &&
                0 <= parseInt(r) &&
                (e += "font-size:" + parseInt(r) + "px;"),
              null != i && (e += "color:" + i + ";"),
              null != a))
          )
            return (
        ...
        (t.prototype.setFonts = function (t, e) {
          ...
          if (
            ...
            null != this.params.design &&
              ...
              (r = this.params.design.params[e + "-font-size"]),
            ...
            for (l = [], n = 0, o = t.length; n < o; n++)
              ((s = t[n]),
                null != r && (s.style.fontSize = parseInt(r) + "px"),
                null != i && (s.style.color = i),
                null != a ? l.push((s.style.fontFamily = a)) : l.push(void 0));
            return l;
          }
        }),
        ...
        (t.prototype.initType = function () {
          ...
          if (
            ...
            switch (
              ((m = 0),
              (o = new Date()),
              parseInt(this.params.type.currentType))
            ) {
              case 1:
              ...
              case 2:
                if (
                  ...
                  (r = parseInt(this.params.type.params.hours)),
                  (s = parseInt(this.params.type.params.minutes)),
                  (n = parseInt(this.params.type.params.seconds)),
                  (null == e || isNaN(e)) && (e = 0),
                  (null == r || isNaN(r)) && (r = 0),
                  (null == s || isNaN(s)) && (s = 0),
                  (null == n || isNaN(n)) && (n = 0),
                  ...
                  if (
                    ((a = this.getCookie("timer" + this.id)),
                    isNaN(a) && (a = null),
                    null != a &&
                      null == (l = new Date(parseInt(a))) &&
                      (a = null),
                    null == a)
                  ) {
                    ((l = new Date()).setDate(l.getDate() + e),
                      l.setHours(l.getHours() + r),
                      l.setMinutes(l.getMinutes() + s),
                      l.setSeconds(l.getSeconds() + n));
                    var c = l.getTime(),
                      g = new Date(l.getTime());
                    (g.setDate(g.getDate() + 3),
                      this.setCookie("timer" + this.id, c, {
                        expires: g,
                        path: "/",
                      }));
                  }
              ...
              case 3:
                if (
                  ...
                  for (
                    (2 ===
                      (p = this.params.type.params.time.split(":")).length &&
                      0 <= p[0] &&
                      p[0] <= 23 &&
                      0 <= p[1] &&
                      p[1] <= 59) ||
        ...
        (t.prototype.newTime = function (t) {
          ...
          if (
            ...
            for (n in ((s = !t), this.timerElements))
              ((i = document.getElementById(
                "timer-number-value-" + this.id + "-" + n,
              )),
                (o = (a = this.timerElements[n]).value),
                (e = !1),
                s && ((o -= 1), (e = !0)),
                (s = !1),
                o < a.min && ((o = a.max), (e = s = !0)),
        ...
        (t.prototype.getColorBetween = function (t, e, i) {
          ...
          return (
            ...
            !(null == this.getIEVersion() || this.getIEVersion() < 9)
              ? "#" + s(r(t.r, e.r)) + s(r(t.g, e.g)) + s(r(t.b, e.b))
              : ((a = (t.a + (e.a - t.a) * i).toFixed(2)),
                "rgba(" +
                  r(t.r, e.r) +
                  "," +
                  r(t.g, e.g) +
        ...
        (t.prototype.getGradientColors = function (t, e, i) {
          var a, r, s, n;
          for (r = [], n = 1 / (i - 1), s = a = 0; s < i; )
            ((r[s] = this.getColorBetween(t, e, a)), (a += n), s++);
          return r;
        }),
        ...
        (t.prototype.drawGradientArc = function (
          ...
          if (
            (r && this.drawArc(m, d, h, u, t, e, c, "transparent", r, s, g),
            g || (1 === e ? (t = 1 - e) : (e = 1 - e)),
            (w = this.hexToRgb(i)),
            (x = this.hexToRgb(a)),
            (T = this.hexToRgb(this.getColorBetween(w, x, t))),
            (I = this.hexToRgb(this.getColorBetween(w, x, e))),
            (b = Math.ceil(30 * Math.abs(e - t))),
            (y = this.getGradientColors(T, I, b)),
            (n = -0.5 * Math.PI + 2 * Math.PI * t),
            (l = y.length),
            (f = g
              ? ((k = (2 * Math.PI * (e - t)) / l), 1)
              : ((k = (-2 * Math.PI * (e + t)) / l), -1)),
            (E = function (t, e, i) {
              ...
              return (
                ...
                (p = h + Math.sin(e + k) * u),
                m.beginPath(),
                (a = m.createLinearGradient(n, o, l, p)).addColorStop(0, r),
                a.addColorStop(1, s),
                (m.lineCap = i),
                (m.strokeStyle = a),
                m.arc(d, h, u, e - 0.005 * f, e + k + 0.005 * f, !g),
                (m.lineWidth = c),
                m.stroke(),
                m.closePath()
              );
            ...
            if (((o = n + k * (l - 1)), 1 < l)) {
              for (
                p = M = 0, L = (v = Math.ceil(l / 2)) - 1;
                0 <= L ? M <= L : L <= M;
                p = 0 <= L ? ++M : --M
              )
                (0 === p && ((C = k), (k *= 0.01), E(p, n, s), (k = C)),
                  E(p, n, "butt"),
                  (n += k));
              for (
                n = o, S = [], p = N = H = l - 1;
        ...
        (t.prototype.drawArc = function (t, e, i, a, r, s, n, o, l, p, m) {
          if (r <= s)
            return "string" != typeof o
              ? this.drawGradientArc(t, e, i, a, r, s, n, o[0], o[1], l, p, m)
              : (t.beginPath(),
                (t.lineWidth = n),
                (t.strokeStyle =
        ...
        (t.prototype.drawRing = function (
          ...
          if (
            ((y = 1) < y + 0 && ((y -= -1 + y + 0), (r += 0)),
            (f = (v = r) + y),
            (g = r + ((b = a * y) - 0 * (w = 0.5 - Math.abs(-0.5 + a)))),
            (x = r + (b + 0 * (1 - w))),
            s || p)
          )
            return (
              this.drawArc(t, e, i, s, x, f, n, o, l, u, c),
        ...
        (t.prototype.circleTick = function () {
          ...
          0,
          "round",
          (s = this.params.design.params["line-color"]),
          (l = this.params.design.params["background-color"]),
          null,
          (r = "direct" === this.params.design.params.direction),
          (d = []),
          this.timerElements))
        ...
        (t.prototype.plateTick = function () {
          ...
          for (o in ((l = function (t, e) {
            var i, a, r;
            if (d.animationSupport() && d.params.design.params.animation)
              return (
                (r = d.params.design.params.effect),
                (i = document.getElementById(
                  "timer-number-" + r + t + "-" + d.id + "-" + e,
                )),
                d.removeClass(i, "timer-" + r + "-animate"),
                (a = d),
                requestAnimationFrame(function () {
                  return (
                    i.offsetLeft,
                    a.addClass(i, "timer-" + r + "-animate")
                  );
                })
              );
          }),
          ...
          (d = this).timerElements))
            this.timerElements[o].updated
              ? ((t = this.timerElements[o].value),
                (m = [t % 10, Math.floor((t / 10) % 10), Math.floor(t / 100)]),
                (r = 0),
                e.push(
                  function () {
                    var t, e, i;
                      ...
                      switch (((p = m[t]), this.params.design.params.effect)) {
                        case "flipchart":
                          null !=
                            ...
                            (a = n.childNodes[0].childNodes) &&
                            null != a &&
                            5 === a.length &&
                            a[0].innerHTML !== p &&
                            ((s = parseInt(a[1].innerHTML)),
                            !1,
                            (null != s && 0 <= s && s <= 9) || (!0, (s = "")),
                            this.params.design.params.animation || (s = p),
                            (s === p && this.params.design.params.animation) ||
                              ((a[0].innerHTML = s),
                              (a[1].innerHTML = p),
                              (a[2].innerHTML = p),
                              (a[3].innerHTML = s),
        ...
        (t.prototype.addCssLink = function (t) {
          ...
          if (
            ...
            for (
              e = i.childNodes[0], n = (o = a[(s = 0)].childNodes).length;
              s < n;
              s++
            )
          ...
          if (o) {
            for (
              ...
              ((e +=
                ...
                s++);
            for (
              e += '#timer-tester:before { content:" "; font-size:5px;', s = 0;
              s < i.length;
            )
              ((e += i[s] + "animation:csspseudoanimations 1ms infinite;"),
                (e += i[s] + "animation-fill-mode: forwards;"),
                s++);
            ((l = '<style id="s-timer-tester">' + (e += "}") + "</style>"),
              ...
              null != t.fake &&
                ...
                (r = docElement.style.overflow),
                (docElement.style.overflow = "hidden"),
                docElement.appendChild(t)),
              (o =
                "10px" ===
                window
                  .getComputedStyle(a, ":before")
                  .getPropertyValue("font-size")),
              null != t.fake
                ? (t.parentNode.removeChild(t),
                  (docElement.style.overflow = r),
